...
export const QUIZ_META: QuizMeta[] = [
  ...
  },
  {
    ...
    color: "#16a34a",
    icon: "🇧🇷",
    thumbnail: "/quiz-thumbnails/brazil-states.jpg",
    thumbnailAlt: "NASA satellite view of the Brazilian Amazon",
    thumbnailFit: "cover",
    thumbnailPosition: "center center",
    featured: true,
  },
  {
    ...
    color: "#0ea5e9",
    icon: "🏙️",
    thumbnail: "/quiz-thumbnails/brazil-capitals.jpg",
    thumbnailAlt: "Brasília and the Monumental Axis",
    thumbnailFit: "cover",
    thumbnailPosition: "center center",
    featured: false,
  },
  ...
  },
  {
    ...
    thumbnailAlt: "The European Champion Clubs' Cup trophy",
    thumbnailFit: "cover",
    thumbnailPosition: "center center",
    featured: false,
  },
  {
    ...
    color: "#f59e0b",
    icon: "🏆",
    thumbnail: "/quiz-thumbnails/brasileirao.jpg",
    thumbnailAlt: "Maracanã Stadium in Rio de Janeiro",
    thumbnailFit: "cover",
    thumbnailPosition: "center center",
    featured: false,
  },
  {
    ...
    color: "#f97316",
    icon: "🏆",
    thumbnail: "/quiz-thumbnails/copa-do-brasil.jpg",
    thumbnailAlt: "Mineirão Stadium in Belo Horizonte",
    thumbnailFit: "cover",
    thumbnailPosition: "center center",
    featured: false,
  },
